...
export const hyperlocalPages: Record<string, HyperlocalPageData> = {
  "realtor-services": {
    ...
    heroSubtitle:
      "Buyer and seller representation, luxury home sales, relocations, and investment consulting — hyperlocal expertise with Centennial Hills Real Estate.",
    ...
    answerBullets: [
      "Buyer & seller representation — Centennial Hills Real Estate",
    ...
    body: [
      ...
      "Every service includes Centennial Hills Real Estate marketing, professional photography coordination, negotiation strategy, and access to a global referral network when you relocate in or out of Nevada.",
    ...
    serviceLinks: [
      ...
      },
      {
        ...
        description: "List your home with Dr. Jan marketing",
  ...
  "centennial-hills-realtor": {
    ...
    description:
      "Dr. Jan Duffy is a Top 1% Centennial Hills REALTOR® with Centennial Hills Real Estate. . Serving 89144, 89138, and 89135 with 500+ closed transactions.",
    heroSubtitle:
    ...
    answerText:
      "Dr. Jan Duffy is a Centennial Hills Real Estate REALTOR® () specializing in Centennial Hills and northwest Las Vegas. The Google Business Profile shows 5.0 from 1 Google review. She offers same-day showings and complimentary market analysis in ZIP codes 89144, 89138, and 89135.",
    answerBullets: [
    ...
    body: [
      ...
      "Her E-E-A-T credentials include Nevada license , Centennial Hills Real Estate affiliation, and verifiable transaction history across guard-gated, golf-course, and new-build neighborhoods.",
    ...
    faqs: [
      {
        ...
        answer: "Nevada license  — displayed on all marketing and verified with the Nevada Real Estate Division.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Hyperlocal Centennial Hills focus, same-day showings, complimentary CMAs, and direct service for luxury and move-up clients.",
      },
    ],
  ...
  "buy-home-centennial-hills": {
    ...
    answerBullets: ["ZIP 89144 · Centennial Hills core", "Same-day showings available", "First-time & move-up buyers welcome", "Dr. Jan buyer representation"],
    body: [
      ...
      "Your buyer plan includes pre-approval guidance, neighborhood tours, comparable sales analysis, and coordination with lenders, inspectors, and title — all with Centennial Hills Real Estate transaction management.",
    ],
    faqs: [
      {
  ...
  "sell-home-centennial-hills": {
    ...
    description:
      "Sell your Centennial Hills home with Dr. Jan Duffy. Free market analysis, Dr. Jan marketing, and pricing strategy for sellers in ZIP 89144, 89138, and northwest Las Vegas.",
    heroSubtitle:
      "Maximize your Centennial Hills sale with professional marketing, accurate pricing, and Centennial Hills Real Estate exposure.",
    image: siteImages.services.luxuryHomeSellers,
    answerQuestion: "How do I sell my house in Centennial Hills?",
    answerText:
      "List with Dr. Jan Duffy for a complimentary market analysis, Dr. Jan professional marketing, staging guidance, and negotiation strategy tailored to Centennial Hills buyers. She prices against true 89144 comps and markets to relocation and equity buyers across California and the west coast.",
    answerBullets: ["Free CMA for 89144 sellers", "Dr. Jan global marketing reach", "Same-day showing coordination", "Divorce, probate & relocation sales"],
    body: [
  ...
  "zip-89144-homes-for-sale": {
    ...
    answerBullets: ["Centennial Hills · Northwest Las Vegas", "Parks & newer construction", "Near Skye Canyon & Lone Mountain", "Dr. Jan Duffy · "],
    body: [
  ...
  "zip-89138-homes-for-sale": {
    ...
    description:
      "Homes for sale in ZIP 89138 northwest Las Vegas near Centennial Hills. Buyer and seller services from Dr. Jan Duffy, Centennial Hills Real Estate REALTOR®.",
    ...
    answerBullets: ["Northwest Las Vegas · 89138", "Move-up & luxury inventory", "Near Lone Mountain & Centennial Hills", "Dr. Jan buyer & seller representation"],
    body: [
