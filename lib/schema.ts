/**
 * Schema.org Structured Data Generators for centennialhillshomesforsale.com
...
export function generateRealEstateAgentSchema() {
  return {
    ...
    slogan: "Centennial Hills & northwest Las Vegas homes — Dr. Jan Duffy, REALTOR®",
  };
}
