      ...
      <section class="hero-section">
        <div class="container container-center">
          ...
          <p class="hero-subtitle">
            Experience white-glove service for luxury home buyers in Las Vegas with Dr. Jan Duffy's specialized expertise in premium properties. 
...
export const head: DocumentHead = {
  title: 'Luxury Home Buyers - Premium Las Vegas Properties | Dr. Jan Duffy',
  meta: [
    {
      name: 'description',
      content: 'Exclusive luxury home buyer services with Dr. Jan Duffy, Top 1% Las Vegas REALTOR®. Premium Las Vegas properties, off-market opportunities, and custom estates in Centennial Hills. Available 24/7 for executive clients.',
    },
  ],
};
