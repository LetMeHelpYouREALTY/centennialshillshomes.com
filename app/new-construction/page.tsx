...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, most builders require your agent to accompany you or be registered on your FIRST visit. If you visit alone and sign the guest registry, you may forfeit your right to free representation. Call (702) 903-1952 to register Dr. Jan Duffy as your buyer's agent before visiting any model home.",
      },
    },
    {
      "@type": "Question",
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm">
                    ...
                    Call <a href="tel:+17029031952" className="font-bold underline">(702) 903-1952</a> to 
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-6 flex-grow">
                  ...
                  <p className="text-slate-600">
                    Call{" "}
                    <a href="tel:+17029031952" className="text-blue-600 font-semibold hover:underline">
                      (702) 903-1952
                    </a>{" "}
