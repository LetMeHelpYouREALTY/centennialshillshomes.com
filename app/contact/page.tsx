...
export const metadata: Metadata = buildPageMetadata({
  ...
  keywords: [
    ...
    "Centennial Hills realtor phone",
    "89144 real estate office",
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div className="rounded-xl overflow-hidden shadow-md mb-4">
                <iframe
                  src="https://www.google.com/maps?q=1490+Center+Crossing+Rd,+Las+Vegas,+NV+89144&hl=en&z=15&output=embed"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="flex gap-3 mb-8">
                ...
                <a
                  href="https://www.google.com/maps/search/?api=1&query=1490+Center+Crossing+Rd,+Las+Vegas,+NV+89144"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-slate-300">DrDuffy@CentennialHillsHomesForSale.com</div>
                </div>
              </a>
            </div>
          </section>
