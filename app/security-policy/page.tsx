      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6">
              ...
              <ul className="space-y-2 text-blue-800">
                <li>
                  <strong>Email:</strong>{' '}
                  <a href="mailto:security@centennialhillshomesforsale.com" className="underline">
                    security@centennialhillshomesforsale.com
                  </a>
                </li>
                <li>
                  <strong>Phone:</strong>{' '}
                  <a href="tel:+17029031952" className="underline">
                    (702) 903-1952
                  </a>
                </li>
                <li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Ensure you're on the correct domain: <strong>centennialhillshomesforsale.com</strong></li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="mb-2">
                Email:{' '}
                <a href="mailto:info@centennialhillshomesforsale.com" className="text-blue-600 underline">
                  info@centennialhillshomesforsale.com
                </a>
              </p>
              <p>
                Phone:{' '}
                <a href="tel:+17029031952" className="text-blue-600 underline">
                  (702) 903-1952
                </a>
              </p>
            </div>
